...
public class VideoFolderActivity extends AppCompatActivity {
    ...
    com.example.salsa_videoannotation.VideoFolderAdapter videoFolderAdapter;
    String myFolderName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            videoFolderAdapter = new com.example.salsa_videoannotation.VideoFolderAdapter(this, videoFilesArrayList);
