...
public class AnnotationData
{
    ...
    public AnnotationData(int id, long startTime, List<String> category, List<String> bodyPart, String content, Bitmap thumbnail) {
        this(id, startTime, category, bodyPart, content, null, thumbnail);
    }

    public AnnotationData(int id, long startTime, List<String> category, List<String> bodyPart, String content, QuizQuestion quizQuestion, Bitmap thumbnail) {
        this.id = id;
